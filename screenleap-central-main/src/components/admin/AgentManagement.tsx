...
export default function AgentManagement() {
  ...
  const labels = {
    zh: {
      title: "SI 代理商管理",
      subtitle: "指派使用者為SI 代理商，並設定其可檢視的多個組織（read-only 跨組織）",
      addAgent: "新增SI 代理商",
      pickUser: "選擇使用者",
      ...
      addOrg: "加入組織",
      pickOrg: "選擇組織",
      removeAgent: "撤銷SI 代理商身份",
      removeConfirm: "撤銷SI 代理商身份",
      ...
      inviteAgentByEmail: "Email 邀請SI 代理商",
      inviteDialogTitle: "Email 邀請新SI 代理商",
      inviteDialogDesc: "對方收到信後完成註冊即會自動成為SI 代理商，並取得所選組織之檢視權限",
      emailLabel: "Email",
      orgsLabel: "授權組織（可多選）",
      send: "送出邀請",
    ...
    en: {
      title: "SI Agent Management",
      subtitle: "Assign users as SI agents (system integrators) with view-only access across multiple orgs",
      addAgent: "Add SI Agent",
      pickUser: "Pick User",
      searchPlaceholder: "Email or name…",
      noResults: "No users found",
      noAgents: "No SI agents yet",
      assignedOrgs: "Assigned Orgs",
      addOrg: "Add Org",
      pickOrg: "Select Org",
      removeAgent: "Revoke SI Agent",
      removeConfirm: "Revoke SI agent role",
      ...
      inviteAgentByEmail: "Invite SI Agent by Email",
      inviteDialogTitle: "Invite New SI Agent by Email",
      inviteDialogDesc: "When the recipient signs up via the invitation, they automatically become an SI agent with view-only access to the selected orgs",
      emailLabel: "Email",
    ...
    ja: {
      title: "SI 代理店管理",
      subtitle: "ユーザーをSI 代理店として割り当て、複数組織の閲覧専用アクセスを設定",
      addAgent: "SI 代理店追加",
      pickUser: "ユーザー選択",
      searchPlaceholder: "メールまたは名前…",
      noResults: "ユーザーが見つかりません",
      noAgents: "SI 代理店がまだいません",
      assignedOrgs: "割当組織",
      addOrg: "組織を追加",
      pickOrg: "組織を選択",
      removeAgent: "SI 代理店権限取消",
      removeConfirm: "SI 代理店権限を取り消す",
      ...
      inviteAgentByEmail: "メールでSI 代理店を招待",
      inviteDialogTitle: "メールで新規SI 代理店を招待",
      inviteDialogDesc: "招待を受けた相手が登録すると自動的にSI 代理店として有効化され、選択した組織の閲覧権限が付与されます",
      emailLabel: "メール",
